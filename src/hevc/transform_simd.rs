...
use super::transform::{get_dct32_coef, DCT16_MATRIX, DCT32_EVEN, DCT32_ODD};
...
unsafe fn idct32_1d_avx2(src: &[i16; 32], dst: &mut [i32; 32], shift: i32, add: i32) {
    ...
    let add_vec = _mm256_set1_epi32(add);
...
unsafe fn idct32_1d_horizontal_avx2(src: &[i32], dst: &mut [i16; 32], shift: i32, add: i64) {
    // For horizontal pass, we need i64 accumulation to avoid overflow
    // Process in scalar mode with i64 or use multiple SIMD passes
