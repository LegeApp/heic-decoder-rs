...
pub static INIT_VALUES: [u8; context::NUM_CONTEXTS] = [
    ...
    149, // PART_MODE (4) - First value must be 184 for I-slice (per libde265 initValue_part_mode)
    ...
    91, 171, 134, 141, // SIG_COEFF_FLAG (44 = 42 + 2 skipmode)
    ...
    111, 136, 139, 111, 141, 111, // COEFF_ABS_LEVEL_GREATER1_FLAG (24)
